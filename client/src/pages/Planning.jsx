...
import { usePlanningMensuel } from "../hooks/queries/usePlanning";
...
const STATUT_LABELS = {
  ...
  ARRIVED_AT_PICKUP: "Sur place",
  PATIENT_ON_BOARD: "À bord",
  ARRIVED_AT_DESTINATION: "Arrivé",
  WAITING_AT_DESTINATION: "En attente",
  COMPLETED: "Terminé",
  BILLED: "Facturé",
  CANCELLED: "Annulé",
  NO_SHOW: "Absent",
...
export default function Planning() {
  ...
  const transportsJour = jourSelectionne ? transportsParJour[cleJour(jourSelectionne)] || [] : [];
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: "#0f172a", margin: 0 }}>Planning</h1>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <button onClick={moisPrecedent} style={btnNav}>
            ←
          </button>
          <span
            style={{
          ...
          <button onClick={moisSuivant} style={btnNav}>
            →
          </button>
